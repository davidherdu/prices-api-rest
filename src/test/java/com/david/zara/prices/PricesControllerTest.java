...
public class PricesControllerTest {
    ...
    private static final String PRICES_API_PATH = "/api/prices?";
    ...
    void givenProduct35455_Brand1_Date20200614_1000_thenPrice35() {
        ...
        RestAssured
        .when()
            .get("http://localhost:" + port + PRICES_API_PATH + "appDate=2020-06-14T10:00:00&productId=35455&brandId=1")
        .then().log().body()
    ...
    void givenProduct35455_Brand1_Date20200614_1600_thenPrice25() {
        ...
        RestAssured
        .when()
            .get("http://localhost:" + port + PRICES_API_PATH + "appDate=2020-06-14T16:00:00&productId=35455&brandId=1")
        .then().log().body()
            .contentType("application/json")
            .statusCode(200).and()
            .body("productId", Matchers.equalTo(35455))
    ...
    void givenProduct35455_Brand1_Date20200614_2100_thenPrice35() {
        ...
        RestAssured
        .when()
            .get("http://localhost:" + port + PRICES_API_PATH + "appDate=2020-06-14T21:00:00&productId=35455&brandId=1")
        .then().log().body()
            .contentType("application/json")
            .statusCode(200).and()
            .body("productId", Matchers.equalTo(35455))
    ...
    void givenProduct35455_Brand1_Date20200615_1000_thenPrice30() {
        ...
        RestAssured
        .when()
            .get("http://localhost:" + port + PRICES_API_PATH + "appDate=2020-06-15T10:00:00&productId=35455&brandId=1")
        .then().log().body()
            .contentType("application/json")
            .statusCode(200).and()
            .body("productId", Matchers.equalTo(35455))
    ...
    void givenProduct35455_Brand1_Date20200616_2100_thenPrice38() {
        ...
        RestAssured
        .when()
            .get("http://localhost:" + port + PRICES_API_PATH + "appDate=2020-06-16T21:00:00&productId=35455&brandId=1")
        .then().log().body()
            .contentType("application/json")
            .statusCode(200).and()
            .body("productId", Matchers.equalTo(35455))
